...
public class EncodingToolbars {
	...
	public static ToolBar keyboardToolBar = new ToolBar(new Label("From:"), EncodingChoices.leftQwerty, new Label("To:"),
			EncodingChoices.rightQwerty,EncodingButtons.convertKeyboard);
